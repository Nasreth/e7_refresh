...
#Search for the refresh button
    RB_pos=pyautogui.locateOnScreen('refresh_button.PNG',confidence=0.98)
#Search for covenant bookmarks
    Coven_pos=pyautogui.locateOnScreen('covenant.PNG',confidence=0.98)
#Search for mystic bookmarks
    Mystic_pos=pyautogui.locateOnScreen('mystic.PNG',confidence=0.98)
#Buy
    Coven_buy=pyautogui.locateOnScreen('new_coven.png',confidence=0.98)
    Mystic_buy=pyautogui.locateOnScreen('new_mystic.png',confidence=0.98)
#Covenant Function
    if (Coven_pos) != None and cont_coven==0 :
        print("Buy Covenant Summons.")
        Coven_point=pyautogui.center(Coven_pos)
        pyautogui.click(x=Coven_point[0]+1050, y=Coven_point[1]+20, clicks=2, interval=0.05, button='left')
        time.sleep(0.05)#wait for confirm button
        Buy_button_Covenant_pos=pyautogui.locateOnScreen('Buy_button_Covenant.PNG',confidence=0.95)
...
#Mystic Function
    if (Mystic_pos) != None and cont_mystic==0:
        ...
        pyautogui.click(x=Mystic_point[0]+1050, y=Mystic_point[1]+20, clicks=2, interval=0.05, button='left')
        time.sleep(0.05)#wait for confirm button
        Buy_button_Mystic_pos=pyautogui.locateOnScreen('Buy_button_Mystic.PNG',confidence=0.95)
...
#Refresh
    if count>=2 :
        ...
        Confirm_point=pyautogui.center(pyautogui.locateOnScreen('confirm button.PNG'))
        ##Confirm_point=pyautogui.center(Confirm_pos) breaks here sometimes
